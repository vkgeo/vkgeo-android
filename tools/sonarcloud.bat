...
IF NOT "%~1"=="" (
     ...
     && androiddeployqt.exe --input android-libvkgeo.so-deployment-settings.json --output android-output --android-platform %ANDROID_PLATFORM% --deployment bundled --gradle --no-gdbserver ^
     && CD .. ^
