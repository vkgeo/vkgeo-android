...
SET PATH=%PATH%;C:\Qt\5.12.10\android_armv7\bin;%ANDROID_NDK_ROOT%\prebuilt\%ANDROID_NDK_HOST%\bin;%SONARCLOUD_ROOT%\build-wrapper-win-x86;%SONARCLOUD_ROOT%\sonar-scanner-4.3.0.2102-windows\bin
...
IF NOT "%~1"=="" (
     ...
     && sonar-scanner.bat -D"sonar.projectKey=vkgeo_vkgeo-android" ^
                          ...
                          -D"sonar.exclusions=3rdparty/**/*,android/source/3rdparty/**/*,qml/**/*,translations/*" ^
